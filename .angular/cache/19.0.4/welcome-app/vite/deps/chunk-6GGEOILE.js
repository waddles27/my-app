...
function serializeLContainer(lContainer, tNode, lView, parentDeferBlockId, context) {
  ...
  for (let i = CONTAINER_HEADER_OFFSET; i < lContainer.length; i++) {
    ...
    if (!serializedView) {
      ...
      if (!isHydrateNeverBlock) {
        serializedView = __spreadValues(__spreadValues({}, serializedView), serializeLView(lContainer[i], parentDeferBlockId, context));
      }
    }
...
@angular/core/fesm2022/core.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-6GGEOILE.js.map
